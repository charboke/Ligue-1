...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../public/css/modificationClub.css">
</head>
        ...
        <div class="card formulaire">
          <div class="card-body corpsFormulaire">
            <div class="card-text">
              ...
              <form action="../controller/traitementModification.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-group mb-3" style="border-radius: 50px !important;">
                  ...
                  <select type="select" required name="nom_club" id="email" class="form-select" aria-label="Username" aria-describedby="basic-addon1" style="border-radius: 50px !important;">
